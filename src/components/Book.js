...
function Book() {
    ...
    const submitHandler = (e) => {
        ...
        if (destTo !== destFrom) {
            ...
            alert("Destination 'From' and 'To' cannot be same.")
        }
    }
  ...
  return (
      <div className="mt-[160px] mx-4 md:mt-[160px] relative">
          <div className="bg-white rounded-md max-w-6xl w-full mx-auto">
              <form className="first-hero inputform" onSubmit={submitHandler}>
                  {/* <!-- From --> */}
                  <div className="des-from">
                      ...
                      <div className="flex flex-row">
                          ...
                          <select
                              className="outline-none px-2 py-2 w-full" name="from"
                              id="from"
                              value={destFrom}
                  ...
                  <div className="des-from !border-r-0">
                      ...
                      <div className="flex flex-row">
                          ...
                          <select
                              className="outline-none px-2 py-2 w-full" name="ticketClass"
                              id="ticketClass"
                              value={classType}
